...
export default function HeroCarousel() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full h-[500px] md:h-[700px] overflow-hidden bg-gray-100 font-sans group"
    >
      ...
      <button
        onClick={handlePrev}
        className="absolute left-4 top-1/2 transform -translate-y-1/2 z-30 bg-white/50 hover:bg-white text-gray-800 p-3 rounded-full shadow-md backdrop-blur-sm transition-all duration-300 opacity-0 group-hover:opacity-100"
      ...
      <button
        onClick={handleNext}
        className="absolute right-4 top-1/2 transform -translate-y-1/2 z-30 bg-white/50 hover:bg-white text-gray-800 p-3 rounded-full shadow-md backdrop-blur-sm transition-all duration-300 opacity-0 group-hover:opacity-100"
